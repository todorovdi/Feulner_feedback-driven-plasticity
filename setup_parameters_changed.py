...
def main(name='train',rand_seed=0):
    ...
    n = 1000 # (original was 400)
    tau = 0.05
    nonlin = 'relu'
    grec = 0 # initialize recurrent weights in chaotic regime? ()
    fb_initial = 1 # initialize feedback weights smaller or larger? 
    in_initial = 3.5 # initialize input weights smaller or larger?
    fb_sparsity = 1.0 # sparseness of feedback signal 
    rec_sparsity = 1.0 # other tested so far: 0.5, 0.8
    fb_type = 'poserrorfb'
    model_input_dim = 3
    model_output_dim = 2
    ...
    # PROTOCOL ###############################
    # try to make few of them to see if it works
